...
type IconName = 'calendar' | 'patients' | 'billing' | 'plus' | 'close' | 'user' | 'phone' | 'email' | 'file' | 'note' | 'drag' | 'check' | 'cash' | 'card' | 'time';

interface IconProps {
  name: IconName;
  className?: string;
}
// FIX: Added React import to define JSX.Element type.
const ICONS: Record<IconName, JSX.Element> = {
  calendar: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />,
  patients: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.653-.124-1.282-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.653.124-1.282.356-1.857m0 0a3.004 3.004 0 014.288 0M14 7a4 4 0 11-8 0 4 4 0 018 0z" />,
  billing: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 8h6m-5 4h4m2 4h-3a2 2 0 00-2 2v2a2 2 0 002 2h3a2 2 0 002-2v-2a2 2 0 00-2-2zM5 8h.01M5 12h.01M5 16h.01M5 20h.01M9 4h6a2 2 0 012 2v12a2 2 0 01-2 2H9a2 2 0 01-2-2V6a2 2 0 012-2z" />,
  ...
  drag: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 12h16M4 18h16" />,
